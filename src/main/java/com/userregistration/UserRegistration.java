...
public class UserRegistration {
    ...
    String VALIDATE_PASSWORD_UPPER_CASE = "^(?=.*[A-Z])[a-zA-Z]{8,}$";
    String VALIDATE_PASSWORD_DIGIT = "^((?=.*[A-Z])(?=.*[a-z])(?=.*[0-9])).{8,}$";
    String VALIDATE_PASSWORD_SPECIAL_CHARACTER = "^(?=.*[A-Z])(?=.*[a-z])(?=.*[0-9])(?=[^$@!#%*?&]*[$#@!%*?&][^$@!#%*?&]*$).{8,}$";
    ...
    public Boolean validatePasswordSpecialCharacter(String password) {
        return password.matches(VALIDATE_PASSWORD_SPECIAL_CHARACTER);
    }
}
